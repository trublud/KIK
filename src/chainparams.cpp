...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    const char* pszTimestamp = "Noah Collette Jacob";
     const CScript genesisOutputScript =  CScript() << 0x0 << OP_CHECKSIG;// ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    ...
    //    vSeeds.emplace_back("seed-b.litecoin.loshan.co.uk");
     //   vSeeds.emplace_back("dnsseed-testnet.thrasher.io");
        ...
        checkpointData = (CCheckpointData) {
            {
                {2056, uint256S("26dba8ba0ad2a711e5583b791488c494cc080d7e27ebe74e286dba5a25a53e")},
            }
        };
